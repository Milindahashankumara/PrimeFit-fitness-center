    ...
    <div className="min-h-screen bg-brand-dark">
      ...
      <header className="bg-brand-gray border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link href="/" className="text-2xl font-bold">
            Prime<span className="text-brand-red">Fit</span> <span className="text-sm text-gray-400">Admin Panel</span>
          </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Monitor and manage your fitness center</p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-brand-gray p-6 rounded-xl border-l-4 border-blue-500">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs bg-blue-500/20 text-blue-400 px-2 py-1 rounded">24</span>
            </div>
          ...
          <div className="bg-brand-gray p-6 rounded-xl border-l-4 border-yellow-500">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs bg-yellow-500/20 text-yellow-400 px-2 py-1 rounded">+22%</span>
            </div>
            <h3 className="text-3xl font-bold mb-1">LKR 84.5K</h3>
          ...
          <div className="bg-brand-gray p-6 rounded-xl border-l-4 border-purple-500">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs bg-purple-500/20 text-purple-400 px-2 py-1 rounded">+8%</span>
            </div>
            <h3 className="text-3xl font-bold mb-1">2,345</h3>
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="bg-yellow-500/20 border border-yellow-500 rounded-xl p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-yellow-400">3 coach applications awaiting review</p>
                <p className="text-sm text-yellow-400/80">Review and approve new coach registrations</p>
              </div>
            </div>
            <Link
          ...
          <div className="bg-red-500/20 border border-red-500 rounded-xl p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-red-400">New customer complaints require attention</p>
                <p className="text-sm text-red-400/80">Review and respond to customer feedback</p>
              </div>
            </div>
            <Link
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-5 gap-6">
            ...
            >
              ...
              <p className="text-sm text-gray-400 mb-4">Review and approve registrations</p>
            ...
            >
              ...
              <p className="text-sm text-gray-400 mb-4">Moderate and approve reviews</p>
              <div className="flex items-center gap-2 text-brand-red font-semibold text-sm group-hover:gap-3 transition-all">
            ...
            >
              ...
              <p className="text-sm text-gray-400 mb-4">Address customer concerns</p>
              <div className="flex items-center gap-2 text-brand-red font-semibold text-sm group-hover:gap-3 transition-all">
            ...
            >
              ...
              <p className="text-sm text-gray-400 mb-4">Create and publish updates</p>
              <div className="flex items-center gap-2 text-brand-red font-semibold text-sm group-hover:gap-3 transition-all">
            ...
            >
              ...
              <p className="text-sm text-gray-400 mb-4">Share workout plans & guides</p>
              <div className="flex items-center gap-2 text-brand-red font-semibold text-sm group-hover:gap-3 transition-all">
            ...
            <div className="group bg-brand-gray rounded-2xl p-6 border border-white/10 hover:border-brand-red/50 transition-all hover:scale-105 cursor-pointer">
              <div className="w-14 h-14 bg-gradient-to-br from-gray-500 to-slate-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <Settings className="text-white" size={28} />
              </div>
              <h3 className="text-lg font-bold mb-2">System Settings</h3>
              <p className="text-sm text-gray-400 mb-4">Configure preferences</p>
              <div className="flex items-center gap-2 text-brand-red font-semibold text-sm group-hover:gap-3 transition-all">
            ...
            <div className="space-y-3">
              <div className="bg-black/40 p-4 rounded-lg flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">Jessica Martinez joined Premium Plan</p>
              ...
              <div className="bg-black/40 p-4 rounded-lg flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">LKR 299 from John Smith - Annual Membership</p>
              ...
              <div className="bg-black/40 p-4 rounded-lg flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">New coach application from Mike Johnson</p>
              ...
              <div className="bg-black/40 p-4 rounded-lg flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">Yoga class added for Wednesday 6:00 PM</p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="w-full bg-black/40 rounded-full h-3">
                  <div className="bg-brand-red h-3 rounded-full" style={{ width: '43%' }}></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-black/40 rounded-full h-3">
                  <div className="bg-blue-500 h-3 rounded-full" style={{ width: '39%' }}></div>
                </div>
              </div>
              ...
              <div className="bg-black/40 p-4 rounded-lg mt-6">
                ...
                <p className="text-sm text-gray-400 mb-3">+187 new members this month</p>
          ...
          <div className="bg-brand-gray p-6 rounded-xl">
            ...
            <div className="space-y-3">
              <div className="bg-red-500/20 border border-red-500/50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-red-400">Equipment Maintenance</h3>
                    <p className="text-sm text-gray-400">5 machines require immediate maintenance</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-yellow-500/20 border border-yellow-500/50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-yellow-400">Expiring Memberships</h3>
                    <p className="text-sm text-gray-400">48 memberships expiring this week</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-500/20 border border-blue-500/50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-blue-400">Staff Schedule</h3>
                    <p className="text-sm text-gray-400">3 coaching slots need to be filled next week</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-500/20 border border-green-500/50 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  <Activity className="text-green-500 flex-shrink-0" size={20} />
                  <div>
                    <h3 className="font-semibold text-green-400">System Health</h3>
            ...
            <div className="mt-6 bg-black/40 p-4 rounded-lg">
              ...
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm font-semibold">LKR 84.5K / LKR 100K</span>
              </div>
              <div className="w-full bg-black/40 rounded-full h-3">
                <div className="bg-gradient-to-r from-brand-red to-yellow-500 h-3 rounded-full" style={{ width: '84.5%' }}></div>
              </div>
            </div>
          </div>
        </div>
