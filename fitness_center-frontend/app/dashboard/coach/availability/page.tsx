...
const AvailabilityPage = () => {
  ...
  const [availabilitySlots, setAvailabilitySlots] = useState<TimeSlot[]>([
    { id: '1', day: 'Monday', startTime: '09:00', endTime: '12:00', sessionType: 'personal', isRecurring: true },
    { id: '2', day: 'Monday', startTime: '14:00', endTime: '18:00', sessionType: 'personal', isRecurring: true },
    { id: '3', day: 'Tuesday', startTime: '09:00', endTime: '12:00', sessionType: 'group', isRecurring: true },
    { id: '4', day: 'Wednesday', startTime: '09:00', endTime: '17:00', sessionType: 'personal', isRecurring: true },
    { id: '5', day: 'Thursday', startTime: '10:00', endTime: '15:00', sessionType: 'online', isRecurring: true },
    { id: '6', day: 'Friday', startTime: '09:00', endTime: '16:00', sessionType: 'personal', isRecurring: true },
  ]);
  ...
  const getSlotsByDay = (day: string) => {
    return availabilitySlots.filter(slot => slot.day === day).sort((a, b) => 
  ...
  const getSessionTypeColor = (type: string) => {
    switch (type) {
      case 'personal': return 'bg-blue-500/20 text-blue-400 border-blue-500';
      case 'group': return 'bg-purple-500/20 text-purple-400 border-purple-500';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Manage your weekly availability and blocked dates</p>
              </div>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {showSuccess && (
          <div className="mb-6 bg-green-500/20 border border-green-500 rounded-xl p-4 flex items-center gap-3 animate-pulse">
            ...
            <p className="font-semibold text-green-400">Schedule updated successfully!</p>
          </div>
        )}
                              ...
                              <div className="flex items-center gap-3 flex-1">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center gap-2 mt-1">
                                    <span className={`text-xs px-2 py-1 rounded border ${getSessionTypeColor(slot.sessionType)}`}>
          ...
          <div className="bg-brand-gray rounded-2xl max-w-md w-full p-6 border border-white/10">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {(['personal', 'group', 'online'] as const).map((type) => (
                    <button
                      key={type}
                      onClick={() => setNewSlot({ ...newSlot, sessionType: type })}
              ...
              <div className="flex items-center justify-between p-3 bg-black/40 rounded-lg">
                ...
                <button
                  onClick={() => setNewSlot({ ...newSlot, isRecurring: !newSlot.isRecurring })}
