      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {tools.map((tool, index) => (
            <div
              key={index}
              className="bg-brand-gray p-6 rounded-xl border border-white/5 hover:border-brand-red/50 transition-all group cursor-pointer text-center relative overflow-hidden"
            >
              ...
              <div className="relative z-10 flex flex-col items-center gap-4">
                ...
                <h3 className="font-bold text-lg uppercase font-mono">
                  {tool.title}
                </h3>
