...
exports.updateProfile = async (req, res) => {
  try {
    ...
    const allowedUpdates = ['name', 'phone', 'dateOfBirth', 'gender', 'address', 'city', 'zipCode', 'emergencyContact', 'emergencyPhone', 'fitnessGoals', 'medicalConditions', 'preferences', 'bio', 'specializations', 'certifications', 'hourlyRate', 'availability'];
